...
echo "            __Owncloud 8.1.3 fail2ban installer__"
echo ""
...
sudo curl -o "$FILTERFILE" "https://raw.githubusercontent.com/AykutCevik/owncloud-fail2ban/owncloud-8.1/automated-install/fail2ban/filter.owncloud.conf"
sudo curl -o "$JAILFILE" "https://raw.githubusercontent.com/AykutCevik/owncloud-fail2ban/owncloud-8.1/automated-install/fail2ban/jail.owncloud.conf"
